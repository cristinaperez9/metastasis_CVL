...
#sys.path.append(pth_add)
sys.path.append(os.path.dirname(os.path.realpath(__file__)))
import numpy as np
#sys.path.insert(1, '/scratch_net/biwidl311/Cristina_Almagro/pytorch3D/medicaldetectiontoolkit/utils/')
...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.root_dir = '//scratch_net/biwidl311/Cristina_Almagro/pytorch3D/toy_dataset'

        ########################################
        #         I/O    (Input/Output paths)       #
        ########################################
        ...
        self.n_train_val_data = 1500  # This is the same as the number of training images ¿?
        ...
        if server_env:  # Note that in this case the server_env is set to none
            # path to preprocessed data.
        ...
        self.num_epochs = 7  # 24
        self.num_train_batches = 30 if self.dim == 2 else 200  ## it was 100!!!!
        ...
        self.val_mode = 'val_sampling'  # ADDED BY ME
