...
########################################################################################################################
# Code adapted by: Cristina Almagro Perez, 2022. ETH university
########################################################################################################################
...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.root_dir = r'/usr/bmicnas01/data-biwi-01/bmicdatasets/Processed/Cristina_Almagro/my_3D_dataset/'
        #self.root_dir = r'/usr/bmicnas01/data-biwi-01/bmicdatasets/Processed/Cristina_Almagro/my_3D_dataset_modify_architectures/'

        self.raw_data_dir = r'/usr/bmicnas01/data-biwi-01/bmicdatasets/Processed/Cristina_Almagro/my_3D_dataset/'
        #self.raw_data_dir = r'/usr/bmicnas01/data-biwi-01/bmicdatasets/Processed/Cristina_Almagro/my_3D_dataset_modify_architectures/'

        self.pp_dir = '{}/preprocessed'.format(self.root_dir)
        ...
        self.n_train_val_data = 218  # This is the same as the number of training images

        # path to preprocessed data.
        self.pp_name = 'preprocessed/train'
        self.input_df_name = 'info_df.pickle'
        self.pp_data_path = os.path.join(self.root_dir, self.pp_name)
        self.pp_test_name = 'preprocessed/test'
        self.pp_test_data_path = os.path.join(self.root_dir, self.pp_test_name)

        # settings for deployment in cloud: NOT NEEDED FOR OUR METASTASES DATASET.
        if server_env:
            # path to preprocessed data.
        ...
        self.patch_size_3D = [128, 128, 64]  # Note that 128 is divisible by 2 five times & 64 is div. by 2 three times
        self.patch_size = self.patch_size_2D if self.dim == 2 else self.patch_size_3D
        self.pre_crop_size = self.pre_crop_size_2D if self.dim == 2 else self.pre_crop_size_3D

        # ratio of free sampled batch elements before class balancing is triggered
        # (>0 to include "empty"/background patches.)
        self.batch_sample_slack = 0.1 # I have changed it to 0.1 but before was 0.2
        ...
        #self.num_epochs = 40    # It was 100!!
        #self.num_epochs = 60
        self.num_epochs = 500

        self.num_train_batches = 200 if self.dim == 2 else 150  # IT WAS 200
        self.batch_size = 20 if self.dim == 2 else 8  # IT WAS 8
        ...
        if self.val_mode == 'val_sampling':
            self.num_val_batches = 35 #### it was 50
        ...
        self.test_n_epochs = 1  # It was 5!!!! # I changed it to 1 for making inference!
        ...
        self.patient_class_of_interest = 1  # patient metrics are only plotted for one class. # It was 2 before
        #self.ap_match_ious = [0.1, 0.25, 0.5, 0.75]  # list of ious to be evaluated for ap-scoring.
        ...
        self.min_det_thresh = 0.5  # minimum confidence value to select predictions for evaluation. # It should be optimized for each network I guess #0.72
        ...
        self.plot_prediction_histograms = False  # It was True before
        ...
        'alpha':(0., 1500.),  # Magnitude of the elastic deformation
        'sigma':(30., 50.),  # Scale of the elastic deformation
        'do_rotation':True,
        'angle_x': (0., 2 * np.pi),
        'angle_y': (0., 0),
        'angle_z': (0., 0),
    ...
    def add_det_unet_configs(self):
        ...
        self.class_specific_seg_flag = False  # Loss only distinguishes between foreground (tumor) vs. background
    ...
    def add_mrcnn_configs(self):
        ...
        #self.learning_rate = [1e-5] * self.num_epochs  # I MODIFIED THIS
        self. n_workers = 8
        ...
        #self.backbone_strides = {'xy': [4, 8, 16, 32, 64], 'z': [1, 2, 4, 8, 16]}  #  ResNet101

        # anchor scales are chosen according to expected object sizes in data set. Default uses only one anchor scale
        # per pyramid level. (outer list are pyramid levels (corresponding to BACKBONE_STRIDES), inner list are scales per level.)
        self.rpn_anchor_scales = {'xy': [[8], [16], [32], [64]], 'z': [[2], [4], [8], [16]]}
        #self.rpn_anchor_scales = {'xy': [[8], [16], [32], [64], [64]], 'z': [[2], [4], [8], [16], [16]]}  #  ResNet101
        ...
        self.post_nms_rois_training = 500 if self.dim == 2 else 150  ##### It was 75! I changed it to 300 and 150
